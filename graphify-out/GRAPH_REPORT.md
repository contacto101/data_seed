# Graph Report - dataseed-multibranch-snapshot-r_uv8tyw  (2026-06-21)

## Corpus Check
- 136 files · ~112,445 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1241 nodes · 1637 edges · 130 communities (114 shown, 16 thin omitted)
...
## Knowledge Gaps
- **575 isolated node(s):** `daily-operations-wrapper.sh script`, `daily-operations.sh script`, `CompletedProcess`, `daily-operations-wrapper.sh script`, `daily-operations.sh script` (+570 more)
...
- **Why does `Reporte Ejecutivo para Stakeholders — DataSeed.cl` connect `Community 94` to `Community 96`, `Community 97`, `Community 79`, `Community 80`, `Community 49`, `Community 81`, `Community 82`, `Community 62`, `Community 95`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `PurePosixPath` connect `Community 5` to `Community 22`?**
