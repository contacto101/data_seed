...
- Generado UTC: 2026-09-11 08:01:18 UTC
- Generado America/Santiago: 2026-09-11 05:01:18 -03
...
- Repo/branch de tracking: `/tmp/tmp.pcpQI4MuQQ/tracking-workspace` / `feat/task-tracking-system`.
...
- `2073a6cc3d6e` [active]
  ...
  - Schedule: 0 8,9 * * *
  - Next run UTC: 2026-09-11T09:00:00+00:00
  - Last run UTC/status: 2026-09-10T09:00:02.899405+00:00 / ok
  - Mode: no-agent
...
- `3d3a4d137152` [active]
  ...
  - Schedule: */10 * * * *
  - Next run UTC: 2026-09-11T08:10:00+00:00
  - Last run UTC/status: 2026-09-11T08:00:47.785381+00:00 / ok
  - Mode: no-agent
...
- `channel_directory.json`: 648.0 B, sha256 c3072d2085e9e4a0
- `gateway_state.json`: 731.0 B, sha256 feb59e3a9a7485b4
- `cron/jobs.json`: 5.6 KB, sha256 c7735aba12bc87c8
